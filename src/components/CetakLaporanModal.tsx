...
import { Jurnal, Kelas, Mapel, Guru, Sekolah, Jurusan } from '../types';
...
export default function CetakLaporanModal({
  ...
  // 1. By Class
  let selectedJournals = jurnals.filter(j => j.kelasId === classId);
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              <h3 className="text-sm font-extrabold text-slate-850">
                Prapinjau Cetak Laporan - {type === 'harian' ? 'Harian' : type === 'mingguan' ? 'Mingguan' : 'Bulanan'}
              </h3>
        ...
        <div className="flex-1 p-6 md:p-10 overflow-y-auto bg-white" id="printable-area">
          ...
          <div className="text-center mb-6 space-y-1">
            <h3 className="text-base font-extrabold tracking-wide uppercase text-slate-900 underline decoration-slate-400 underline-offset-4">
              {type === 'harian' ? 'LAPORAN REKAPITULASI JURNAL MENGAJAR HARIAN' : type === 'mingguan' ? 'LAPORAN REKAPITULASI JURNAL MENGAJAR MINGGUAN' : 'LAPORAN REKAPITULASI JURNAL MENGAJAR BULANAN'}
            </h3>
